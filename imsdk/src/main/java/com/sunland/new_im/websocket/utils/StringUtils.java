...
public class StringUtils {
    ...
    public static SpannableString getSpannedString(
            String originText, int colorStart, int colorEnd, int color,
            int fontStart, int fontEnd, int sizeFont) {
        final SpannableString spannableString = new SpannableString(originText);
        spannableString.setSpan(
                new ForegroundColorSpan(color), colorStart, colorEnd, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        if (sizeFont > 0) {
            spannableString.setSpan(
                    new AbsoluteSizeSpan(sizeFont), fontStart, fontEnd, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
